...
export const Gnosis = ({ size = 24 }: SVGProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <rect width="24" height="24" fill="url(#pattern-gnosis-icon)" />
    <defs>
      <pattern
        id="pattern-gnosis-icon"
        patternContentUnits="objectBoundingBox"
        width="1"
        height="1"
      >
        <use xlinkHref="#image-gnosis-icon" transform="scale(0.0133333)" />
      </pattern>
      <image
        id="image-gnosis-icon"
        width="75"
        height="75"
